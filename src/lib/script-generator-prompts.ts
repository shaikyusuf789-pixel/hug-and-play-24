...
================================================================
Below are TWO canonical sky academy reference transcripts (Cartesia-formatted).
These TWO transcripts are MANDATORY for EVERY script-generation mode --
topic, transcript-rewrite, PDF/book, priority. No mode is exempt.
Before writing a single line, internally study them and mimic:
