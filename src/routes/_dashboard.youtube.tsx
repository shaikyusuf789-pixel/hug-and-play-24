    ...
    <div className="p-8 max-w-7xl mx-auto space-y-8">
      <div className="flex justify-between items-center">
        <div>
          ...
          <h1 className="text-3xl font-bold text-slate-900">YouTube Studio</h1>
        </div>
      ...
      {!selectedScriptId ? (
        <Card className="border-dashed border-2 bg-slate-50/50">
          <CardContent className="py-20 flex flex-col items-center justify-center text-center">
            ...
            <h2 className="text-xl font-bold text-slate-900 mb-2">Select a script to begin</h2>
                    ...
                    <div className="flex p-1 bg-slate-100 rounded-2xl">
                      <button 
                        ...
                        className={cn(
                          ...
                          thumbnailMode === "generate" ? "bg-white shadow-sm text-slate-900" : "text-slate-500 hover:text-slate-700"
                        )}
                      >
                        AI Generate
                      </button>
                      <button 
                        ...
                        className={cn(
                          "flex-1 py-2 px-4 rounded-xl text-xs font-bold transition-all",
                          thumbnailMode === "upload" ? "bg-white shadow-sm text-slate-900" : "text-slate-500 hover:text-slate-700"
                        )}
                      >
                        Upload Mode
                      </button>
